...
public class EarthquakeAdapter extends ArrayAdapter<Earthquake> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView primaryLocationView = (TextView) listItemView.findViewById(R.id.primary_location_textview);
        TextView locationOffsetView = (TextView) listItemView.findViewById(R.id.location_offset_textview);
        String fullLocation = currentEarthquake.getLocation();
        String[] locationArray = new String[2];
        if (fullLocation.contains(" of ")) {
            locationArray = fullLocation.split(" of ");
            locationArray[0] += " of";
        }
        else {
            locationArray[0] = "Near the";
            locationArray[1] = fullLocation;
        }
        locationOffsetView.setText(locationArray[0]);
